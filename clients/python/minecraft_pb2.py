...
_MINECRAFTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='updateEntityAI',
    full_name='dk.itu.real.ooe.MinecraftService.updateEntityAI',
    index=6,
    containing_service=None,
